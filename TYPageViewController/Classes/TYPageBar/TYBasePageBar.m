...
- (void)setProgressView:(UIView *)progressView {
    ...
    if (_layout && _layout.barStyle == TYPageBarStyleCoverView) {
...
- (void)setDelegate:(id<TYBasePageBarDelegate>)delegate {
    _delegate = delegate;
...
- (void)setLayout:(TYBasePageBarLayout *)layout {
...
- (TYBasePageBarLayout *)layout {
    if (!_layout) {
        _layout = [[TYBasePageBarLayout alloc]initWithPagerTabBar:self];
    }
    return _layout;
}
