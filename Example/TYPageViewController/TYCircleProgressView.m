...
NSString * const TYProgressViewProgressAnimationKey = @"UAProgressViewProgressAnimationKey";

@interface TYCircularProgressView : UIView
...
@interface TYCircleProgressView () <UIGestureRecognizerDelegate ,CAAnimationDelegate>

@property (nonatomic, strong) TYCircularProgressView *progressView;
@property (nonatomic, assign) int valueLabelProgressPercentDifference;
@property (nonatomic, strong) NSTimer *valueLabelUpdateTimer;

@end

@implementation TYCircleProgressView
...
- (void)sharedSetup {
    self.progressView = [[TYCircularProgressView alloc] initWithFrame:self.bounds];
...
- (void)animateToProgress:(CGFloat)progress {
    ...
    [self.progressView.layer addAnimation:animation forKey:TYProgressViewProgressAnimationKey];
...
- (void)stopAnimation {
    ...
    [self.progressView.layer removeAnimationForKey:TYProgressViewProgressAnimationKey];
...
@implementation TYCircularProgressView
