...
@interface TYWeiBoPhotoViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, weak) UITableView *tableView;
@end
static NSString *const kWeiBoCellIdentifier = @"TYWeiBoCell";
@implementation TYWeiBoPhotoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = @"WBStatusPhotoCell";
    return cell;
}
