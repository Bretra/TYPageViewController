...
@interface TYWeiBoVideoViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, weak) UITableView *tableView;
@end
static NSString *const kWeiBoCellIdentifier = @"TYWeiBoCell";
@implementation TYWeiBoVideoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = @"WBStatusVideoCell";
