...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TYPageViewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1130128166@qq.com/TYPageViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1130128166@qq.com' => 'wangzhiming@tuyabeat.com' }
  s.source           = { :git => 'https://github.com/1130128166@qq.com/TYPageViewController.git', :tag => s.version.to_s }
